"""
Это скачанный пакет readability. Нормально установить его не получилось, поэтому просто скопировала.
Может что-то поменяля для совместимости с 3-м Питоном.
"""
#!/usr/bin/env python
import logging
import re
